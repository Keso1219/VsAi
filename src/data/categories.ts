...
export const categories: Category[] = [
  {
    ...
    featured: true,
    toolCount: 12, // Example tool count
  },
  {
    slug: 'website',
    name: 'Website',
    ...
    featured: true,
    toolCount: 8, // Example tool count
  },
  {
    slug: 'writing',
    name: 'Writing',
    ...
    featured: true,
    toolCount: 15, // Example tool count
  },
  {
    slug: 'ai-model',
    name: 'AI Model',
    ...
    featured: true,
    toolCount: 10, // Example tool count
  },
  {
    ...
    toolCount: 5, // Example tool count
  },
  {
    slug: 'chatbot',
    name: 'Chatbot',
    ...
    toolCount: 7, // Example tool count
  },
  {
    slug: 'automation',
    name: 'Automation',
    ...
    toolCount: 9, // Example tool count
  },
  {
    slug: 'ui-ux',
    name: 'UI/UX',
    ...
    toolCount: 6, // Example tool count
  },
  {
    ...
    toolCount: 11, // Example tool count
  },
  {
    slug: 'video',
    name: 'Video',
    ...
    toolCount: 4, // Example tool count
  },
  {
    slug: 'design',
    name: 'Design',
    ...
    iconUrl: 'https://img.icons8.com/fluency/48/000000/design.png',
    toolCount: 13, // Example tool count
  },
  {
    slug: 'marketing',
    name: 'Marketing',
